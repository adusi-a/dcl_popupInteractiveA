 ...
 *   Dig Worms at soil patch / buy Basic Bait at Fishmonger
 *   Buy rod at Fishmonger → Cast at Fishing Pond → Catch fish → Sell at Fishmonger
 */
...
export class GameManager {
  ...
  constructor() {
    ...
    console.log('[GameManager] Fishmonger X=28 Z=120, Trader at Z~147, Farm plots at Z~138-152')
    console.log('[GameManager] Worm Field X=25-32 Z=50-56, Fishing Pond X=28 Z=152')
  }
}
